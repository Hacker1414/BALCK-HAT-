...
\x1b[38;5;46m______________________________________________________
 ...
 \033[1;31m[\033[1;32m[R]\033[1;31m]\033[1;32m DEVELOPER : MD Tajul Islam Rabbi
...
def Main():
	...
	if opt in ["C","3"]:
		...
		fb()
	if opt in ["D","4"]:
		os.system('xdg-open https://wa.me/+880814032575');time.sleep(1)
		group()
	if opt in ["0","0"]:
		exit()
...
def b(uid,pwx,tl):
    ...
    # 'cookie': 'sb=nkyFZPzbaQhck0LNuibMNyb3; datr=nkyFZFHnRmG61E3aOECMaFpG; dpr=2; m_pixel_ratio=2; wd=360x666; fr=0xaks1pt5hm1fFNUD..BkhUye.hW.AAA.0.0.Bkkxp-.AWXZcUooXho',
